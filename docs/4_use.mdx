...
Convenience function to view whether it has expired.

#### getStatus()

Convenience function to view whether it has expired, party elections to terminate, time until expiry, and number of executions.
...
Convenience function to view whether it has expired, time until expiry, and number of executions.
